...
function About() {
  return (
    <>
      <div className="flex flex-wrap justify-center items-center mt-8 sm:mt-12 mb-16 max-w-screen-lg mx-auto px-[24px]">
        ...
        <div className="sm:w-1/2 flex flex-wrap flex-col justify-center md:justify-start items-center md:items-start pl-4">
          <h1 className="text-base3 text-[28px] sm:text-[40px] md:text-[56px] font-bold font-Montserrat">
            TPIC HNBGU
          </h1>
          ...
          <p className="text-white text-[16px] md:text-[20px] leading-[135%] mt-4">
