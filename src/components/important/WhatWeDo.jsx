      ...
      <div className="flex flex-wrap justify-center items-center  mb-12 max-w-screen-lg mx-auto px-[24px] pb-12">
        ...
        <div className=" flex flex-wrap flex-col justify-center items-center">
          ...
          <div className='flex flex-wrap w-full justify-evenly items-center text-center mt-10 gap-4'>
            <div className='w-[360px] sm:w-[280px] md:w-[220px] h-[360px] flex flex-wrap flex-col justify-center items-center  shadow-md shadow-slate-500 rounded-md font-Montserrat text-black/80 bg-white pt-4 pb-8 px-4'>
              ...
              <p className='text-[14px] font-normal leading-[135%] mt-4'>
